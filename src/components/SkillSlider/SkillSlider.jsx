...
const skillData = {
  ...
  "Software & Tools": [
    ...
    { name: "MongoDB Compass" , img: "images/images.png"},
    { name: "Postman", img: "images/postman.png" },
    { name: "Vercel", img: "images/vercel.webp" },
    { name: "Cloudinary", img: "images/cloudinary.png" },
  ],
  "Core Fundamentals": [
  { name: "OS", img: "images/os.webp" },
  { name: "Computer Networks", img: "images/network.webp" },
  { name: "DBMS", img: "images/dbms.jpeg" },
  { name: "DSA", img: "images/dsa.png" },
  { name: "OOPs", img: "images/oops.webp" },
],
Languages: [
  ...
  "Soft Skills": [
    ...
    { name: "Teamwork", img: "images/team.webp" },
    { name: "Time Management", img: "images/time.jpg" },
    { name: "Adaptability", img: "images/adapt.webp" },
  ],
};
